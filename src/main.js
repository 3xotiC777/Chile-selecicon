...
function updatePeriod(){
  ...
  $('period-note').textContent=`${week<3?'Primera quincena · objetivo: 1 visita quincenal.':'Segunda quincena · objetivo: completar 2 visitas quincenales.'} ${week===weeks?'Última semana: Facing puede coincidir con SOVI para cerrar pendientes.':''} ${holidays?'Fijas OSA: '+(100-17*holidays)+' % de la base.':'Fijas OSA: todas las de la planeación.'}`;
